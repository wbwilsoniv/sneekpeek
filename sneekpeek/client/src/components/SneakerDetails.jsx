    ...
    return (
            <div className="sneakerContainer">      
                <div className="single-sneaker">
                    ...
                    <img className="sneakerPic" src={props.sneaker[0].sneak_pic} alt="picture of sneaker" />
                    <span className="sneakerPrice">${props.sneaker[0].price} (USD)</span>
                    <span className="sneakerRelease">Release Date: <br /> {props.sneaker[0].release_date}</span>
                    <span className="editBtn"><button type="button" onClick={(e) => props.edit(props.sneaker[0].id)}>Edit Sneaker</button></span>
